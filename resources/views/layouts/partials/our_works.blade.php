            ...
            <div class="col-md-6 col-xl-3">
                ...
                <div class="thumb thumb-corporate">
                    <div class="thumb-corporate__main">
                        <a href="{{ route('page.show', ['alias' => 'оснащение-гостиничных-номеров-мебелью']) }}#portfolio-{{ $gallery->id }}">
                    ...
                    <div class="thumb-corporate__caption">
                        <p class="thumb__title"><a href="{{ route('page.show', ['alias' => 'оснащение-гостиничных-номеров-мебелью']) }}#portfolio-{{ $gallery->id }}">{{ $gallery->name }}</a></p>
                    </div>
                </div>
            </div>
            @endforeach
